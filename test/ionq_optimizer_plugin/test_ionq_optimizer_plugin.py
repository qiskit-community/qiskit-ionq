...
def test_ionq_optimizer_plugin_simple_one_qubit_rules(gates, optimized_depth):
...
def test_ionq_optimizer_plugin_compact_more_than_three_gates(gates, optimized_depth):
