...
phase_gate.append(GPIGate(-lambda_param/(2*np.pi)/4), [0])
phase_gate.append(GPI2Gate(0.5 - lambda_param/(2*np.pi)/2), [0])
...
rx_gate.append(GPIGate(theta_param/(2*np.pi)/2 - 1/4), [0])
rx_gate.append(GPI2Gate(0.25), [0])
...
ry_gate.append(GPIGate(theta_param/(2*np.pi)/2), [0])
ry_gate.append(GPI2Gate(0.5), [0])
...
# rz_gate.append(GPIGate(theta_param/4), [0])
