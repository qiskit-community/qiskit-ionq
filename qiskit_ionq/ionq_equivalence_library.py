...
# u1_gate.append(GPI2Gate(0.5 - lambda_param/(2*np.pi)), [0])
# u1_gate.append(GPIGate(-lambda_param/(4*np.pi)), [0])
...
# h_gate.append(GPI2Gate(0.25), [0])
# h_gate.append(GPIGate(0), [0])
