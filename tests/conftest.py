...
from ionq_core.models.characterization_fidelity_spam import CharacterizationFidelitySpam
...
def characterization():
    fidelity = CharacterizationFidelity(spam=CharacterizationFidelitySpam(median=0.995))
